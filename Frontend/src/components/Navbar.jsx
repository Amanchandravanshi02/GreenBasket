...
const Navbar= () => {
    ...
    return (
        <div className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b 
            ...
            <NavLink to='/contact'>Contact</NavLink>
                ...
                (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 bg-white
                        shadow border border-gray-200 py-2.5 w-40 rounded-md text-sm z-40'>
